...
public class ModItems {
    ...
    public static final Map<CableColor, RegistryObject<Item>> COVERED_CABLES =
        new EnumMap<>(CableColor.class);
    public static final Map<CableColor, RegistryObject<Item>> COVERED_DENSE_CABLES =
        new EnumMap<>(CableColor.class);
    public static final Map<CableColor, RegistryObject<Item>> GLASS_CABLES =
        new EnumMap<>(CableColor.class);
    public static final Map<CableColor, RegistryObject<Item>> SMART_CABLES =
        new EnumMap<>(CableColor.class);
    public static final Map<CableColor, RegistryObject<Item>> SMART_DENSE_CABLES =
        new EnumMap<>(CableColor.class);
